...
const AgentBadge = ({ agentId }: { agentId?: string }) => {
  ...
  if (agentId === 'MirrorGate' || agentId === 'ApprovalGate') label = 'Review gate';
  if (agentId === 'Chetana') label = 'Source check';
  if (agentId === 'MirrorProof' || agentId === 'ProofRecord') label = 'Evidence trail';
  if (agentId === 'MirrorBrain') label = 'Reasoning route';
